...
window.addEvent('domready', function(){
  ...
  new Slider(slider, slider.getElement('.knob'), {
    ...
    onChange: function(value){
	   ...
	   var s = this.step/100;
	   var w = $('jcrop-image').width;
	   var h = $('jcrop-image').height;
	   var scaleW =  Math.round(w*s);
	   var scaleH =  Math.round(h*s);
	   document.getElementById('scaleimagepreview').innerHTML = this.step+"%";
	   document.getElementById('scaleimage').value= this.step;
    }
  });
