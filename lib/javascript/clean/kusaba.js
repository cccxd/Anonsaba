...
function togglePassword() {
	...
	var passwordbox1 = document.getElementById("passwordbox2");
	if (passwordbox) {
	if (passwordbox1) {
		var passwordbox_html;
		var passwordbox2_html;
		if ((bSaf) || (bOpera) || (bMoz))
			passwordbox_html = passwordbox.innerHTML;
			passwordbox2_html = passwordbox2.innerHTML;
		else 
		passwordbox_html = passwordbox.text;
		passwordbox2_html = passwordbox2.text;
		
		passwordbox2_html = passwordbox2_html.toLowerCase();
		passwordbox_html = passwordbox_html.toLowerCase();
		var newhtml = '<td></td><td></td>';

		if (passwordbox_html == newhtml) {
		if (passwordbox2_html == newhtml) {
		...
		if ((bSaf) || (bOpera) || (bMoz))
			...
			passwordbox2.innerHTML = newhtml;
		else passwordbox.text = newhtml;
			passwordbox2.text = newhtml;
	}
	return false;
}
...
function togglePassword2() {
	...
	var bOpera = (navigator.userAgent.indexOf('Opera') != -1);
	var bMoz = (navigator.appName == 'Netscape');
	var passwordbox = document.getElementById("passwordbox2");
	if (passwordbox) {
		var passwordbox2_html;
		
		if ((bSaf) || (bOpera) || (bMoz))
			passwordbox2_html = passwordbox2.innerHTML;
		else passwordbox2_html = passwordbox2.text;
		...
		if ((bSaf) || (bOpera) || (bMoz))
			passwordbox2.innerHTML = newhtml;
		else passwordbox2.text = newhtml;
	}
	return false;
}
